...
export const BLOCK_DEF = {
  [B.DIRT]:       { name: 'Compacted Dirt',   color: 0x7a5c3a, rough: 0.95, solid: true },
  [B.GRAVEL]:     { name: 'Gravel',            color: 0x6e6e6e, rough: 0.9,  solid: true },
  [B.CONCRETE]:   { name: 'Cracked Concrete',  color: 0x888880, rough: 0.85, solid: true },
  [B.RUST_METAL]: { name: 'Rusted Metal',      color: 0x8B3A00, rough: 0.8,  solid: true,
                    drop: 'iron_scrap', dropChance: 1.0 },
  [B.CLEAN_METAL]:{ name: 'Steel Panel',       color: 0x9fb5c0, rough: 0.4,  solid: true,
                    drop: 'iron_scrap', dropChance: 0.7 },
  [B.WOOD_PLANK]: { name: 'Rotted Wood',       color: 0x6b4c27, rough: 0.9,  solid: true,
                    drop: 'wood_plank', dropChance: 1.0 },
  [B.SCRAP_PILE]: { name: 'Scrap Pile',        color: 0x5a5a4a, rough: 0.95, solid: true,
  ...
  [B.OIL_DRUM]:   { name: 'Oil Drum',          color: 0x1a1a8a, rough: 0.5,  solid: true,
                    drop: 'fuel_can', dropChance: 0.9 },
  [B.CRATE]:      { name: 'Mystery Crate',     color: 0x8b6020, rough: 0.85, solid: true,
                    drop: 'circuit_board', dropChance: 0.5,
                    altDrop: 'copper_wire', altDropChance: 0.8 },
  [B.WALL_METAL]: { name: 'Metal Wall',        color: 0x707070, rough: 0.5,  solid: true },
  [B.ROOF_METAL]: { name: 'Corrugated Roof',   color: 0x607060, rough: 0.55, solid: true },
  [B.JUNK_CAR]:   { name: 'Junk Car',          color: 0x3a3a2a, rough: 0.95, solid: true,
                    drop: 'rubber_chunk', dropChance: 1.0,
                    altDrop: 'gear_small', altDropChance: 0.6 },
  [B.POWER_BOX]:  { name: 'Power Box',         color: 0xddcc00, rough: 0.4,  solid: true,
